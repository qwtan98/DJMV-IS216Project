                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <router-link to="Lessons" class="btn btn-secondary" value="" style="margin-bottom: 10px" v-if='selected_ans.includes("No, it will not lose its value") && selected_ans.includes("No, it is not the same") && selected_ans.includes("No!")'>Return to Lessons</router-link>
